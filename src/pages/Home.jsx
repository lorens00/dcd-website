...
export default function Home() {
  return (
    <>
      <div className="flex flex-col-reverse lg:flex-row items-center justify-between bg-gray-100 p-6 lg:p-10 mb-10">
        {/* Content Section */}
        <div className="w-full lg:w-1/2 text-center lg:text-left mx-3 px-3">
          ...
          <p className="text-base sm:text-lg text-gray-600 mb-6 pr-10">
      ...
      <motion.div
      className="pt-3 pb-10 my-10 lg:my-20"
        initial={{ opacity: 0, y: 100 }} 
        whileInView={{ opacity: 1, y: 0 }} 
        transition={{ duration: .7, ease: "easeOut" }}
        viewport={{ once: true }} 
      ...
      <motion.div
      className="py-10 my-12 lg:my-20"
        initial={{ opacity: 0, y: 100 }} 
        whileInView={{ opacity: 1, y: 0 }} 
        transition={{ duration: .7, ease: "easeOut" }}
        viewport={{ once: true }} 
